...
fig_hist = px.histogram(df_program, x="Birth Date - Yearly")
st.plotly_chart(fig_hist)

# Add a strip plot of math results by nationality
st.header("Birth Date Strip Plot by Nationality")
fig_strip = px.strip(df_program, x="Birth Date - Yearly", y="Nationality")
